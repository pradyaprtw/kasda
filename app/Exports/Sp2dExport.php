...
class Sp2dExport implements FromQuery, WithHeadings, WithMapping, ShouldAutoSize, WithStyles, WithEvents, WithTitle
{
    ...
    {
        // Nama sheet akan menjadi tanggal (misal: 14-07-2024)
    ...
    {
        // Header pink dan rata tengah
        $sheet->getStyle('A1:O1')->applyFromArray([
            'font' => ['bold' => true, 'color' => ['argb' => '000000']],
            'alignment' => ['horizontal' => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER],
            'fill' => [
                'fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID,
                'startColor' => ['argb' => 'FFC0CB'], // Pink
            ],
        ]);
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $lastRow = $sheet->getHighestRow() + 3; // Tambah 3 baris kosong

                // Tulis "Total Keseluruhan" di kolom N
                ...
                $sheet->setCellValue('O' . $lastRow, number_format((float)$totalNetto, 2, ',', '.'));

                // Styling untuk total
                $sheet->getStyle('N' . $lastRow . ':O' . $lastRow)->applyFromArray([
                    'font' => ['bold' => true],
                    'alignment' => ['horizontal' => \PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_RIGHT],
                    'fill' => [
                        'fillType' => \PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID,
                        'startColor' => ['argb' => 'FFE4E1'], // Pink muda untuk highlight
                    ],
                    'borders' => [
                        'allBorders' => [
                            'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
